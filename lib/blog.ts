...
## Luxury Listings: Why Premium Properties Aren't Converting to Showings

High-end listings have a different problem. The price tag filters out casual browsers, so by the time a buyer clicks your $800K+ listing, they're already qualified. If they don't book a showing, **the photos failed to match the price**.

Common reasons luxury property listings don't convert to showings:

- **Interior photos shot on overcast days** — a $1M estate deserves golden-hour or twilight treatment
- **No aerial coverage** — buyers at this price point expect to see the full lot, the approach, the surrounding land
- **Missing lifestyle shots** — pool, outdoor entertaining areas, wine cellar, views
...
1. **Are you FAA Part 107 certified?** Legally required for commercial drone work. If they fly without it, your brokerage is exposed.
2. **Do you carry liability and equipment insurance?** Should be yes. Get the certificate if a property manager or builder requires it.
3. **What's your turnaround?** Standard is 24–48 hours. Anything beyond 72 is a red flag.
4. **How many edited photos do I get and what's the per-extra rate?**
5. **What does mileage cost from your home base to my listing?**
6. **What's included for revisions, and what counts as a "major edit"?**
7. **Can I see a recent shoot from a property similar to mine?** This is the most useful question. Style and editing taste matter more than a round number of years in business.
    ...
    faqs: [
      {
        ...
        a: "Most Kentucky real estate photographers charge $100–$200 for basic interior-only shoots, $150–$300 for interior + exterior, $200–$400 for photo + drone bundles, and $350–$1,500 for cinematic listing video. Louisville and Lexington run 30–60% higher than secondary markets. Final pricing depends on property size, location, services bundled, and turnaround.",
      },
      {
      ...
      },
      {
        ...
        a: "Most photographers have a free service radius (typically 15–30 miles) and bill round-trip mileage or a flat travel fee outside it. For rural Kentucky listings, this can add $25–$150 to the bill. Always confirm travel charges before booking, especially if your photographer is based in a different city.",
      },
      {
        q: "How fast will I get my real estate photos back?",
        a: "Standard turnaround across the Kentucky market is 24–48 hours for edited, MLS-ready deliverables. Same-day or next-morning rush delivery typically adds $25–$100. Anything beyond 72 hours from a working real estate photographer is unusual and worth questioning.",
      },
      {
        q: "Is a real estate photographer worth the cost?",
        a: "Generally yes. Research from RealTrends and the National Association of Realtors consistently shows listings with professional photography sell 32% faster and for $3,000–$11,000 more on average than comparable phone-photo listings. At $150–$400 for a typical package, the cost is a fraction of a single price reduction.",
      },
    ],
  },
];
