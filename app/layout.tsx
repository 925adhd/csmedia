      ...
      <body className="min-h-screen flex flex-col bg-dark-900 text-white">
        <EditModeProvider>
          ...
          <a
            ...
            className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-dark-800 border border-gold/30 text-gold shadow-lg shadow-black/40 transition-transform hover:scale-110 hover:bg-dark-700 active:scale-95"
          >
