        ...
        <div className="mx-auto max-w-7xl px-5 md:px-6 lg:px-12">
          ...
          <CircularShowcase
            ...
            items={[
              ...
              { image: "/images/kentucky-wedding-photography.webp", images: ["/images/kentucky-wedding-photography.webp", "/images/kentucky-baby-shower-event-photography.webp", "/images/kentucky-event-catering-photography.webp"], eyebrow: "Weddings & Special Occasions", title: "Events", description: "Weddings, baby showers, birthdays, and special occasions captured candidly across Central Kentucky.", href: "/services/events", ctaLabel: "Explore Event Photography" },
            ]}
          />
        </div>
      </section>
