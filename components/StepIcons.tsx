...
export function StampIcon(props: SVGProps<SVGSVGElement>) {
  ...
  return (
    <span
      ref={ref}
      className="wired-icon"
      data-icon="stamp"
      data-in-view={inView}
    >
      <svg {...base} {...props}>
        <g transform="rotate(-12 20 20)">
          <circle cx="20" cy="20" r="13" pathLength={1} data-draw="1" />
          <circle cx="20" cy="20" r="10" pathLength={1} data-draw="2" />
          <path d="M15 20.5 l3.2 3.2 l6.5 -6.5" pathLength={1} data-draw="3" />
        </g>
      </svg>
    </span>
  );
    ...
    >
      <svg {...base} {...props}>
        <g transform="rotate(-6 20 22)">
          {/* Polaroid frame */}
          <rect x="9" y="7" width="22" height="26" rx="1" pathLength={1} data-draw="1" />
          {/* Photo area */}
          <rect x="11" y="9" width="18" height="18" pathLength={1} data-draw="2" />
          {/* Horizon line in photo */}
          <path d="M11 22 l3 -3 l4 2 l4 -4 l3 2 l4 -1" pathLength={1} data-draw="3" />
          {/* Sun */}
          <circle cx="24" cy="13" r="1.3" pathLength={1} data-draw="4" />
          {/* Shutter flash overlay (only visible on hover) */}
          <rect
            x="11"
            y="9"
            width="18"
